...
#
# Generated by export_simulation on Tue Apr 23 12:40:21 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './fc1_weights_bram_1.sh' script.

./fc1_weights_bram_1.sh -reset_run
...
./fc1_weights_bram_1.sh -noclean_files

For more information on the script, please type './fc1_weights_bram_1.sh -help'.
