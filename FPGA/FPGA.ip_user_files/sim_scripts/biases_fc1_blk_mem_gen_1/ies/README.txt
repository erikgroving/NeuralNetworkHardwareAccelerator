...
#
# Generated by export_simulation on Wed May 01 14:02:06 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './biases_fc1_blk_mem_gen_1.sh' script.

./biases_fc1_blk_mem_gen_1.sh -reset_run
...
./biases_fc1_blk_mem_gen_1.sh -noclean_files

For more information on the script, please type './biases_fc1_blk_mem_gen_1.sh -help'.
