...
#
# Generated by export_simulation on Sat Apr 20 20:21:28 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './fc1_blk_mem_gen_0.sh' script.

./fc1_blk_mem_gen_0.sh -reset_run
...
./fc1_blk_mem_gen_0.sh -noclean_files

For more information on the script, please type './fc1_blk_mem_gen_0.sh -help'.
