...
HD_PWD='C:/Users/Erik/Desktop/NeuralNetworkHardwareAccelerator/FPGA/FPGA.runs/fc1_weights_bram_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fc1_weights_bram_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fc1_weights_bram_5.tcl
