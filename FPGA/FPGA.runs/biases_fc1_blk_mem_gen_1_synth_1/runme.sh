...
HD_PWD='C:/Users/Erik/Desktop/NeuralNetworkHardwareAccelerator/FPGA/FPGA.runs/biases_fc1_blk_mem_gen_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log biases_fc1_blk_mem_gen_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source biases_fc1_blk_mem_gen_1.tcl
