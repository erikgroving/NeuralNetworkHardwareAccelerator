...
HD_PWD='C:/Users/Erik/Desktop/NeuralNetworkHardwareAccelerator/FPGA/FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neural_net_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neural_net_top.tcl
