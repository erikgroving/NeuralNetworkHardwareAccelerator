...
HD_PWD='C:/Users/Erik/Desktop/NeuralNetworkHardwareAccelerator/FPGA/FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log neural_net_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source neural_net_top.tcl -notrace
