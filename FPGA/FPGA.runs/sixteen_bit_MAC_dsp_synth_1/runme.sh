...
HD_PWD='C:/Users/Erik/Desktop/NeuralNetworkHardwareAccelerator/FPGA/FPGA.runs/sixteen_bit_MAC_dsp_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sixteen_bit_MAC_dsp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sixteen_bit_MAC_dsp.tcl
